const data = {
  "main": {
    "name": "Kateryna Lymanska",
    "occupation": "Software Engineer",
    "description": "I have worked for several companies in the past 5 years and achieved great skills.",
    "image": "profile.png",
    ...
    "email": "limanskaya.c@gmail.com",
    "phone": "+380958519878",
    "address": {
      "street": "Boulevard Jasminovyj 5/2",
      "city": "Kharkiv",
      "state": "Ukraine",
      "zip": "61100"
    },
    "website": "https://limanskayakate.github.io/resume/",
  ...
  "resume": {
    ...
    "work": [
      ...
      },
      {
        ...
        "description": "Luxoft provides technology consulting service and develop custom web applications"
      }
    ],
    "skills": [
      {
  ...
  "testimonials": {
    "testimonials": [
      {
        "text": "She is a hard working and reliable person. It has been always pleasure to work with her.",
        "user": "Pete Walbolt... Project Manager"
      },
      {
        "text": "Kateryna must be one of the most brilliant developers I've ever met! I would like to appreciate her for his speedy and smart work!",
